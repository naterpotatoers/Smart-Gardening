...
const chart = () => { 
  axios
  .get("http://54.213.41.248:5000/dynamo/melody-esp32-1") //Data we are reading
  .then(res => {
   
    for(let dataObj of res.data ){
        if (dataObj.data.nodeId === Node) //getting specific node user
        {
          if(dataObj.data.temperature > 0 ) // ignoring the outlier numbers anything below 0
          {
...
return (
  <div>
    <div>
      ...
      />
      <br/> 
      <Typography align="center" variant="h4"> Temperature vs Entries </Typography>
        </Card>
        <br/> 
        <br/> 
      ...
      />
      <br/> 
      <Typography align="center" variant="h4">Humidity</Typography>
        </Card>
        <br/> 
        <br/> 
      ...
      />
      <br/> 
      <Typography align="center" variant="h4">Soil Moisture</Typography>
        </Card>
        <br/> 
        <br/> 
      ...
      />
      <br/> 
      <Typography align="center" variant="h4">Sun Intensinty</Typography>
        </Card>
